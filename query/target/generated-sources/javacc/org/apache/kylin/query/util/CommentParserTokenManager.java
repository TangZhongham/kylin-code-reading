   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            ...
            {
               case 2:
                  if ((0xffff4ffeffffd9ffL & l) != 0L)
                  {
                     if (kind > 8)
                        kind = 8;
                     jjCheckNAdd(14);
                  }
                  else if ((0xb00100002600L & l) != 0L)
                  {
                     if (kind > 3)
                        kind = 3;
                  }
               ...
               case 1:
                  ...
                  break;
               case 3:
                  if ((0xb00100002600L & l) != 0L && kind > 3)
                     kind = 3;
                  break;
               case 4:
               case 6:
...
"", null, null, null, "\47", null, "\42", null, null, null, null, };
...
/** Constructor. */
public CommentParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public CommentParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
